                        ...
                        <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                            ...
                            <div class="hexagon-menu clear">
                                <div class="hexagon-item">
                                    ...
                                    <a href="/canvas" target="_blank" class="hex-content">
                                        <span class="hex-content-inner">
                                            ...
                                            <span class="title">Portrait Typography</span>
                                        </span>
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <a href="/careers.html" target="_blank" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                                <i class="fa fa-bullseye"></i>
                                            </span>
                                            <span class="title">Portrait Pencil Sketch</span>
                                        </span>
                                        <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <a href="/testimonials.html" target="_blank" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                                <i class="fa fa-braille"></i>
                                            </span>
                                            <span class="title">Portrait Colour Pencil Sketch</span>
                                        </span>
                                        <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <a href="/projects.html" target="_blank" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <a href="/contact.html" target="_blank" class="hex-content">
                                        <span class="hex-content-inner">
                                            <span class="icon">
